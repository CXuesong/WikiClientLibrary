...
namespace WikiClientLibrary.Wikibase
{
    public static class WbEntityExtensions
    {
        ...
        public static Task RefreshAsync(this IEnumerable<WbEntity> entities, EntityQueryOptions options)
        {
            return RefreshAsync(entities, options, null, CancellationToken.None);
        }

        public static Task RefreshAsync(this IEnumerable<WbEntity> entities, EntityQueryOptions options, ICollection<string> languages)
        {
